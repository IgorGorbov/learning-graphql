...
import { Booking, PaginationProps } from "../../../../types";
import { ListingCard } from "../../../ui/ListingCard";

interface Props {
  userBookings: PaginationProps<Booking>;
  bookingsPage: number;
  limit: number;
  ...
  return userBookingsList ? (
    <div className="user-bookings">
      ...
      <Paragraph className="user-bookings__description">
        This section highlights the bookings you've made, and the check-in/check-out dates associated with said
        bookings.
      </Paragraph>
      {userBookingsList}
    </div>
